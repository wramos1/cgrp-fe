...
const BlindSpotWarningIcon = ({ width = '12px', height = '12px', style }) => {
    return (
        <svg
        ...
        >
            <g>
                <path
                    d="M37.087,17.707c-0.229-0.229-3.982-3.971-9.518-6.344l4.146-4.146c0.391-0.392,0.391-1.022,0-1.414s-1.023-0.392-1.414,0
...
export default BlindSpotWarningIcon;